...
export { default as ForbiddenPage } from './Routes/ForbiddenPage';
export { default as ProtectedPage } from './Routes/ProtectedPage';
export { default as ProduitCategoriesTreeView } from './Trees/ProduitCategoriesTree';
export { default as LoadingModal } from './Dialogs/LoadingModal';